...
#import "UIImage+YukeyResize.h"

@interface YukeyBubblePhotoImageView ()

/**
 *  消息类型
 */
@property (nonatomic, assign) YukeyBubbleMessageType bubbleMessageType;

@end

@implementation YukeyBubblePhotoImageView
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.bubbleMessageType == YukeyBubbleMessageTypeSending) {
