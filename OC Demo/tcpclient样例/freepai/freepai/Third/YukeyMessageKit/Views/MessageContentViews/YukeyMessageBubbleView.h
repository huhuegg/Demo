...
#import "YukeyBubblePhotoImageView.h"
#import "SETextView.h"
...
// Categorys
#import "UIImage+YukeyAnimatedFaceGif.h"

#define kXHMessageBubbleDisplayMaxLine 200

#define kXHTextLineSpacing 3.0

@interface YukeyMessageBubbleView : UIView

/**
 *  目标消息Model对象
 */
@property (nonatomic, strong, readonly)  id <YukeyMessageModel> message;
 ...
 *  用于显示仿微信发送图片的控件
 */
@property (nonatomic, weak, readonly) YukeyBubblePhotoImageView *bubblePhotoImageView;
