...
@interface YukeyShareMenuView () <UIScrollViewDelegate>
...
@implementation YukeyShareMenuView
...
- (void)reloadData {
    ...
    CGFloat paddingX = 16;
    CGFloat paddingY = 10;
    for (YukeyShareMenuItem *shareMenuItem in self.shareMenuItems) {
