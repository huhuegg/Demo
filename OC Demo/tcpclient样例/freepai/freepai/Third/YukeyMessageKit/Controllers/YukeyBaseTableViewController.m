//
//  YukeyBaseTableViewController.m
//  freepai
//
...
#import "YukeyBaseTableViewController.h"

#import "YukeyFoundationCommon.h"

@interface YukeyBaseTableViewController ()
...
@implementation YukeyBaseTableViewController
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        tableViewFrame.size.height -= (self.navigationController.viewControllers.count > 1 ? 0 : (CGRectGetHeight(self.tabBarController.tabBar.bounds))) + [YukeyFoundationCommon getAdapterHeight];
