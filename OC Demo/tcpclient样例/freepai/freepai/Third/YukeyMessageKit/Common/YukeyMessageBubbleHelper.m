...
@interface YukeyMessageBubbleHelper () {
    NSCache *_attributedStringCache;
}
@end

@implementation YukeyMessageBubbleHelper
+ (instancetype)sharedMessageBubbleHelper {
    static YukeyMessageBubbleHelper *sharedInstance = nil;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[YukeyMessageBubbleHelper alloc] init];
    });
